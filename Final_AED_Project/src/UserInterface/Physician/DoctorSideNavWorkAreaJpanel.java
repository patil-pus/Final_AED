...
public class DoctorSideNavWorkAreaJpanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 110, 160, 40));

        appointmentsBtn.setBackground(new java.awt.Color(0, 0, 0));
        ...
        jPanel3.add(appointmentsBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 170, 200, 40));

        patientHistorybtn.setBackground(new java.awt.Color(0, 0, 0));
        ...
        jPanel3.add(patientHistorybtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 230, -1, -1));

        createPrescriptionbtn.setBackground(new java.awt.Color(0, 0, 0));
        createPrescriptionbtn.setFont(new java.awt.Font("Lucida Grande", 3, 13)); // NOI18N
        createPrescriptionbtn.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jPanel3.add(createPrescriptionbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 290, 200, 40));

        labTestRequestBtn.setBackground(new java.awt.Color(0, 0, 0));
        labTestRequestBtn.setFont(new java.awt.Font("Lucida Grande", 3, 13)); // NOI18N
        labTestRequestBtn.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jPanel3.add(labTestRequestBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 350, 200, 40));

        personalInfoBtn1.setBackground(new java.awt.Color(0, 0, 0));
        personalInfoBtn1.setFont(new java.awt.Font("Lucida Grande", 3, 13)); // NOI18N
        personalInfoBtn1.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jPanel3.add(personalInfoBtn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 410, 200, 40));
